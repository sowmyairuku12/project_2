...
function Cart() {
  ...
  const deleteCart = (itemId) => {
    dispatch(deleteFromCart(itemId)); // Pass only the ID to the reducer
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_a47sryOPDVTwy6",
      key_secret: "KhMijURcx8T8szHBJf8mtJEK",
            ...
            {cartItems.map((item) => (
              ...
              >
                ...
                <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                  ...
                  <div
                    onClick={() => deleteCart(item.id)} // Pass only the ID
